...
> file paths (local or
> [remote](https://r-lidar.github.io/lasR/articles/remote.md)) stored in
> a vector. It can also be the path to a directory or the path of a
> [virtual point
...
#> source      : file27587f910058.tif 
#> name        : file27587f910058
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/Rtmp3VAdyT/bcts_1_ground.laz /tmp/Rtmp3VAdyT/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/Rtmp3VAdyT/bcts_1_normalized.laz /tmp/Rtmp3VAdyT/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/Rtmp3VAdyT/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. :  
#> source      : file275836f45fbf.tif 
#> name        : file275836f45fbf
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
