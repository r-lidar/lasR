...
#> source      : file28d85289b482.tif 
#> name        : file28d85289b482
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/RtmpKEuEUt/bcts_1_ground.laz /tmp/RtmpKEuEUt/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/RtmpKEuEUt/bcts_1_normalized.laz /tmp/RtmpKEuEUt/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/RtmpKEuEUt/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. :  
#> source      : file28d8899195c.tif 
#> name        : file28d8899195c
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
