...
#> source      : file272c3154975.tif
#> name        : file272c3154975
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/RtmpqrE35h/bcts_1_ground.laz /tmp/RtmpqrE35h/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/RtmpqrE35h/bcts_1_normalized.laz /tmp/RtmpqrE35h/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/RtmpqrE35h/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. : 
#> source      : file272c3b878423.tif
#> name        : file272c3b878423
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
