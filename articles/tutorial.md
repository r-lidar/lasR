...
#> source      : file27587f262ff5.tif
#> name        : file27587f262ff5
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/RtmpRHfnsC/bcts_1_ground.laz /tmp/RtmpRHfnsC/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/RtmpRHfnsC/bcts_1_normalized.laz /tmp/RtmpRHfnsC/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/RtmpRHfnsC/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. : 
#> source      : file2758945bacc.tif
#> name        : file2758945bacc
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
