...
#> source      : file267a680e0805.tif
#> name        : file267a680e0805
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/RtmpekeEXJ/bcts_1_ground.laz /tmp/RtmpekeEXJ/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/RtmpekeEXJ/bcts_1_normalized.laz /tmp/RtmpekeEXJ/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/RtmpekeEXJ/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. : 
#> source      : file267a563bee0d.tif
#> name        : file267a563bee0d
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
