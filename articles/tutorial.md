...
#> source      : file27056d881dc2.tif
#> name        : file27056d881dc2
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/Rtmpvt4RiG/bcts_1_ground.laz /tmp/Rtmpvt4RiG/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/Rtmpvt4RiG/bcts_1_normalized.laz /tmp/Rtmpvt4RiG/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/Rtmpvt4RiG/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. : 
#> source      : file27057e22943a.tif
#> name        : file27057e22943a
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
