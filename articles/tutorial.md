...
#> source      : file26c15886dbee.tif 
#> name        : file26c15886dbee
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/RtmpU5V8TZ/bcts_1_ground.laz /tmp/RtmpU5V8TZ/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/RtmpU5V8TZ/bcts_1_normalized.laz /tmp/RtmpU5V8TZ/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/RtmpU5V8TZ/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. :  
#> source      : file26c160af02d7.tif 
#> name        : file26c160af02d7
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
