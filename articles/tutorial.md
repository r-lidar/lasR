...
#> source      : file26b020d7091f.tif 
#> name        : file26b020d7091f
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/RtmpY5YnCs/bcts_1_ground.laz /tmp/RtmpY5YnCs/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/RtmpY5YnCs/bcts_1_normalized.laz /tmp/RtmpY5YnCs/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/RtmpY5YnCs/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. :  
#> source      : file26b04209740c.tif 
#> name        : file26b04209740c
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
