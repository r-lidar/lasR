...
#> source      : file27b616be2e1.tif
#> name        : file27b616be2e1
```
...
ans = exec(pipeline, on = f)
ans
#>  - write_las : /tmp/RtmpU1DF6U/bcts_1_ground.laz /tmp/RtmpU1DF6U/bcts_2_ground.laz 
#>  - write_las.1 : /tmp/RtmpU1DF6U/bcts_1_normalized.laz /tmp/RtmpU1DF6U/bcts_2_normalized.laz
```
...
ans = exec(merge, on = f)
ans
#> [1] "/tmp/RtmpU1DF6U/dataset_merged.laz"
```
...
#> extent      : 273357, 273643, 5274357, 5274643  (xmin, xmax, ymin, ymax)
#> coord. ref. : 
#> source      : file27b63b487dcd.tif
#> name        : file27b63b487dcd
cloud
#> Source       : LASF (v1.2)
#> Size         : 737.18 kB
