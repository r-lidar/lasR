...
It is **strongly recommended** to use cloud-optimized formats (COPC) with proper spatial or depth queries. This format is designed for efficient partial access over the network.
