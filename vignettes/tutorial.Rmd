...
This tutorial has been written with the R API (`lasR` package) and the codes are thus written in `R`. It should be very similar in `python`. This tutorial is more about the general concept than about coding.
</blockquote>
