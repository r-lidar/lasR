...
The user [@ptompalski](https://github.com/ptompalski) independently produced a more comprehensive set of benchmarks based on more data and pipelines, using a more powerful computer with more cores. [See his report](https://ptompalski.github.io/LidarSpeedTests/).
</blockquote>
