...
Pipeline local_maximum(double ws, double min_height = 2, std::vector<std::string> filter = {""}, std::string ofile = "", std::string use_attribute = "Z", bool record_attributes = false, std::string store_in_attribute = "", std::vector<double> ws_lut = {}, double ws_lut_min = 0, double ws_lut_step = 0.5);
Pipeline local_maximum_raster(std::string connect_uid, double ws, double min_height = 2, std::vector<std::string> filter = {""}, std::string ofile = "", std::vector<double> ws_lut = {}, double ws_lut_min = 0, double ws_lut_step = 0.5);
