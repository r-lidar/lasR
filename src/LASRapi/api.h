...
Pipeline classify_with_ptd(double res = 10, double angle = 30, double distance = 2, double spacing = 0.25, int classification = 2, int max_iter = 100, std::vector<std::string> filter = {""});
