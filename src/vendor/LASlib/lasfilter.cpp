...
{
  print("Filter points based on their coordinates.\n");
  print("  -keep_tile 631000 4834000 1000 (ll_x ll_y size)\n");
  print("  -keep_circle 630250.00 4834750.00 100 (x y radius)\n");
  print("  -keep_xy 630000 4834000 631000 4836000 (min_x min_y max_x max_y)\n");
  print("  -drop_xy 630000 4834000 631000 4836000 (min_x min_y max_x max_y)\n");
  print("  -keep_x 631500.50 631501.00 (min_x max_x)\n");
  print("  -drop_x 631500.50 631501.00 (min_x max_x)\n");
  print("  -drop_x_below 630000.50 (min_x)\n");
  print("  -drop_x_above 630500.50 (max_x)\n");
  print("  -keep_y 4834500.25 4834550.25 (min_y max_y)\n");
  print("  -drop_y 4834500.25 4834550.25 (min_y max_y)\n");
  print("  -drop_y_below 4834500.25 (min_y)\n");
  print("  -drop_y_above 4836000.75 (max_y)\n");
  print("  -keep_z 11.125 130.725 (min_z max_z)\n");
  print("  -drop_z 11.125 130.725 (min_z max_z)\n");
  print("  -drop_z_below 11.125 (min_z)\n");
  print("  -drop_z_above 130.725 (max_z)\n");
  print("  -keep_xyz 620000 4830000 100 621000 4831000 200 (min_x min_y min_z max_x max_y max_z)\n");
  ...
  print("  -keep_first_of_many -keep_last_of_many\n");
  print("  -drop_first_of_many -drop_last_of_many\n");
  print("  -keep_middle -drop_middle\n");
  print("  -keep_return 1 2 3\n");
  print("  -drop_return 3 4\n");
  print("  -keep_single -drop_single\n");
  print("  -keep_double -drop_double\n");
  print("  -keep_triple -drop_triple\n");
  print("  -keep_quadruple -drop_quadruple\n");
  print("  -keep_number_of_returns 5\n");
  print("  -drop_number_of_returns 0\n");
  print("Filter points based on the scanline flags.\n");
  print("  -drop_scan_direction 0\n");
  print("  -keep_scan_direction_change\n");
  print("  -keep_edge_of_flight_line\n");
  print("Filter points based on their intensity.\n");
  print("  -keep_intensity 20 380\n");
  print("  -drop_intensity_below 20\n");
  print("  -drop_intensity_above 380\n");
  print("  -drop_intensity_between 4000 5000\n");
  print("Filter points based on classifications or flags.\n");
  print("  -keep_class 1 3 7\n");
  print("  -drop_class 4 2\n");
  print("  -keep_extended_class 43\n");
  print("  -drop_extended_class 129 135\n");
  print("  -drop_synthetic -keep_synthetic\n");
  print("  -drop_keypoint -keep_keypoint\n");
  print("  -drop_withheld -keep_withheld\n");
  print("  -drop_overlap -keep_overlap\n");
  print("Filter points based on their user data.\n");
  print("  -keep_user_data 1\n");
  print("  -drop_user_data 255\n");
  print("  -keep_user_data_below 50\n");
  print("  -keep_user_data_above 150\n");
  print("  -keep_user_data_between 10 20\n");
  print("  -drop_user_data_below 1\n");
  print("  -drop_user_data_above 100\n");
  print("  -drop_user_data_between 10 40\n");
  print("Filter points based on their point source ID.\n");
  print("  -keep_point_source 3\n");
  print("  -keep_point_source_between 2 6\n");
  print("  -drop_point_source 27\n");
  print("  -drop_point_source_below 6\n");
  print("  -drop_point_source_above 15\n");
  print("  -drop_point_source_between 17 21\n");
  print("Filter points based on their scan angle.\n");
  print("  -keep_scan_angle -15 15\n");
  print("  -drop_abs_scan_angle_above 15\n");
  print("  -drop_abs_scan_angle_below 1\n");
  print("  -drop_scan_angle_below -15\n");
  print("  -drop_scan_angle_above 15\n");
  print("  -drop_scan_angle_between -25 -23\n");
  print("Filter points based on their gps time.\n");
  print("  -keep_gps_time 11.125 130.725\n");
  print("  -drop_gps_time_below 11.125\n");
  print("  -drop_gps_time_above 130.725\n");
  print("  -drop_gps_time_between 22.0 48.0\n");
  print("Filter points based on their RGB/CIR/NIR channels.\n");
  print("  -keep_RGB_red 1 1\n");
  print("  -drop_RGB_red 5000 20000\n");
  print("  -keep_RGB_green 30 100\n");
  print("  -drop_RGB_green 2000 10000\n");
  print("  -keep_RGB_blue 0 0\n");
  print("  -keep_RGB_nir 64 127\n");
  print("  -keep_RGB_greenness 200 65535\n");
  print("  -keep_NDVI 0.2 0.7 -keep_NDVI_from_CIR -0.1 0.5\n");
  print("  -keep_NDVI_intensity_is_NIR 0.4 0.8 -keep_NDVI_green_is_NIR -0.2 0.2\n");
  print("Filter points based on their wavepacket.\n");
  print("  -keep_wavepacket 0\n");
  print("  -drop_wavepacket 3\n");
  print("Filter points based on extra attributes.\n");
  print("  -keep_attribute_above 0 5.0\n");
  print("  -drop_attribute_below 1 1.5\n");
  print("Filter points with simple thinning.\n");
  print("  -keep_every_nth 2 -drop_every_nth 3\n");
  print("  -keep_random_fraction 0.1\n");
  print("  -keep_random_fraction 0.1 4711\n");
  print("  -thin_with_grid 1.0\n");
  print("  -thin_pulses_with_time 0.0001\n");
  print("  -thin_points_with_time 0.000001\n");
  print("Boolean combination of filters.\n");
  print("  -filter_and\n");
  print("Fast AOI Queries for LAS/LAZ with spatial indexing LAX files\n");
  print("  -inside min_x min_y max_x max_y\n");
  print("  -inside_tile ll_x ll_y size\n");
  print("  -inside_circle center_x center_y radius\n");
  print("Fast AOI Queries for LAZ 1.4 with spatial indexing COPC VLR\n");
  print("  -inside min_x min_y max_x max_y\n");
  print("  -inside_circle center_x center_y radius\n");
  print("  -max_depth 3\n");
