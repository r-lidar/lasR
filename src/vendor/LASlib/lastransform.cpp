...
void LAStransform::usage() const
{
  ...
  print("  -translate_x -2.5\n");
  print("  -scale_z 0.3048\n");
  print("  -rotate_xy 15.0 620000 4100000 (angle + origin)\n");
  print("  -translate_xyz 0.5 0.5 0\n");
  print("  -translate_then_scale_y -0.5 1.001\n");
  print("  -transform_helmert -199.87,74.79,246.62\n");
  print("  -transform_helmert 598.1,73.7,418.2,0.202,0.045,-2.455,6.7\n");
  print("  -transform_affine 0.9999652,0.903571,171.67,736.26\n");
  print("  -switch_x_y -switch_x_z -switch_y_z\n");
  print("  -clamp_z_below 70.5\n");
  print("  -clamp_z 70.5 72.5\n");
  print("  -copy_attribute_into_z 0\n");
  print("  -add_attribute_to_z 1\n");
  print("  -add_scaled_attribute_to_z 1 -1.2\n");
  print("  -copy_intensity_into_z\n");
  print("  -copy_user_data_into_z\n");
  print("Transform raw xyz integers.\n");
  print("  -translate_raw_z 20\n");
  print("  -translate_raw_xyz 1 1 0\n");
  print("  -translate_raw_xy_at_random 2 2\n");
  print("  -clamp_raw_z 500 800\n");
  print("Transform intensity.\n");
  print("  -set_intensity 0\n");
  print("  -scale_intensity 2.5\n");
  print("  -translate_intensity 50\n");
  print("  -translate_then_scale_intensity 0.5 3.1\n");
  print("  -clamp_intensity 0 255\n");
  print("  -clamp_intensity_above 255\n");
  print("  -map_intensity map_file.txt\n");
  print("  -copy_RGB_into_intensity\n");
  print("  -copy_NIR_into_intensity\n");
  print("  -copy_attribute_into_intensity 0\n");
  print("  -bin_gps_time_into_intensity 0.5\n");
  print("Transform scan_angle.\n");
  print("  -set_scan_angle 0.0\n");
  print("  -scale_scan_angle 1.944445\n");
  print("  -translate_scan_angle -5\n");
  print("  -translate_then_scale_scan_angle -0.5 2.1\n");
  print("Change the return number or return count of points.\n");
  print("  -repair_zero_returns\n");
  print("  -set_return_number 1\n");
  print("  -set_extended_return_number 10\n");
  print("  -change_return_number_from_to 2 1\n");
  print("  -change_extended_return_number_from_to 2 8\n");
  print("  -set_number_of_returns 2\n");
  print("  -set_extended_number_of_returns 15\n");
  print("  -change_number_of_returns_from_to 0 2\n");
  print("  -change_extended_number_of_returns_from_to 8 10\n");
  print("Modify the classification.\n");
  print("  -set_classification 2\n");
  print("  -set_extended_classification 41\n");
  print("  -change_classification_from_to 2 4\n");
  print("  -classify_z_below_as -5.0 7\n");
  print("  -classify_z_above_as 70.0 7\n");
  print("  -classify_z_between_as 2.0 5.0 4\n");
  print("  -classify_intensity_above_as 200 9\n");
  print("  -classify_intensity_below_as 30 11 \n");
  print("  -classify_intensity_between_as 500 900 15\n");
  print("  -classify_attribute_below_as 0 -5.0 7\n");
  print("  -classify_attribute_above_as 1 70.0 7\n");
  print("  -classify_attribute_between_as 1 2.0 5.0 4\n");
  print("  -change_extended_classification_from_to 6 46\n");
  print("  -move_ancient_to_extended_classification\n");
  print("  -copy_user_data_into_classification\n");
  print("Change the flags.\n");
  print("  -set_withheld_flag 0\n");
  print("  -set_synthetic_flag 1\n");
  print("  -set_keypoint_flag 0\n");
  print("  -set_overlap_flag 1\n");
  print("Modify the extended scanner channel.\n");
  print("  -set_scanner_channel 2\n");
  print("  -copy_user_data_into_scanner_channel\n");
  print("Modify the user data.\n");
  print("  -set_user_data 0\n");
  print("  -scale_user_data 1.5\n");
  print("  -change_user_data_from_to 23 26\n");
  print("  -change_user_data_from_to 23 26\n");
  print("  -map_user_data map_file.txt\n");
  print("  -copy_scanner_channel_into_user_data\n");
  print("  -copy_attribute_into_user_data 1\n");
  print("  -add_scaled_attribute_to_user_data 0 10.0\n");
  print("Modify the point source ID.\n");
  print("  -set_point_source 500\n");
  print("  -change_point_source_from_to 1023 1024\n");
  print("  -map_point_source map_file.txt\n");
  print("  -copy_user_data_into_point_source\n");
  print("  -copy_scanner_channel_into_point_source\n");
  print("  -copy_attribute_into_point_source 0\n");
  print("  -merge_scanner_channel_into_point_source\n");
  print("  -split_scanner_channel_from_point_source\n");
  print("  -bin_Z_into_point_source 200\n");
  print("  -bin_abs_scan_angle_into_point_source 2\n");
  print("  -bin_gps_time_into_point_source 5.0\n");
  print("Transform gps_time.\n");
  print("  -set_gps_time 113556962.005715\n");
  print("  -translate_gps_time 40.50\n");
  print("  -adjusted_to_week\n");
  print("  -week_to_adjusted 1671\n");
  print("Transform RGB/NIR colors.\n");
  print("  -set_RGB 255 0 127\n");
  print("  -set_RGB_of_class 9 0 0 255\n");
  print("  -scale_RGB 2 4 2\n");
  print("  -scale_RGB_down (by 256)\n");
  print("  -scale_RGB_up (by 256)\n");
  print("  -scale_RGB_to_8bit (only scales down 16 bit values)\n");
  print("  -scale_RGB_to_16bit (only scales up 8 bit values)\n");
  print("  -scale_NIR 2\n");
  print("  -scale_NIR_down (by 256)\n");
  print("  -scale_NIR_up (by 256)\n");
  print("  -scale_NIR_to_8bit (only scales down 16 bit values)\n");
  print("  -scale_NIR_to_16bit (only scales up 8 bit values)\n");
  print("  -switch_R_G -switch_R_B -switch_B_G\n");
  print("  -copy_R_into_NIR -copy_R_into_intensity\n");
  print("  -copy_G_into_NIR -copy_G_into_intensity\n");
  print("  -copy_B_into_NIR -copy_B_into_intensity\n");
  print("  -copy_intensity_into_NIR\n");
  print("  -switch_RGBI_into_CIR\n");
  print("  -switch_RGB_intensity_into_CIR\n");
  print("Transform attributes in \"Extra Bytes\".\n");
  print("  -scale_attribute 0 1.5\n");
  print("  -translate_attribute 1 0.2\n");
  print("  -copy_user_data_into_attribute 0\n");
  print("  -copy_z_into_attribute 0\n");
  print("  -map_attribute_into_RGB 0 map_height_to_RGB.txt\n");
  print("Transform using \"LASregisters\".\n");
  print("  -copy_attribute_into_register 0 0\n");
  print("  -scale_register 0 1.5\n");
  print("  -translate_register 1 10.7\n");
  print("  -add_registers 0 1 3\n");
  print("  -multiply_registers 0 1 2\n");
  print("  -copy_intensity_into_register 0\n");
  print("  -copy_R_into_register 1\n");
  print("  -copy_G_into_register 2\n");
  print("  -copy_B_into_register 3\n");
  print("  -copy_NIR_into_register 4\n");
