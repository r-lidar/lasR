  ...
  for (int i = 0; i < num_geo_keys; i++)
  {
    ...
    case 2050: // GeogGeodeticDatumGeoKey
      ...
      case 6024: // DatumE_Krassowsky1940
        ...
        break;
      default:
        eprint("GeogGeodeticDatumGeoKey: look-up for %d not implemented\n", geo_keys[i].value_offset);
      }
      break;
    case 2052: // GeogLinearUnitsGeoKey
      ...
      case 9003: // Linear_Foot_US_Survey
        ...
        break;
      default:
        eprint("GeogLinearUnitsGeoKey: look-up for %d not implemented\n", geo_keys[i].value_offset);
      }
      break;
    ...
    case 3075: // ProjCoordTransGeoKey
      ...
      case 2: // CT_TransvMercator_Modified_Alaska
        eprint("ProjCoordTransGeoKey: CT_TransvMercator_Modified_Alaska not implemented\n");
        break;
      case 3: // CT_ObliqueMercator
        user_defined_projection = 3;
        break;
      case 4: // CT_ObliqueMercator_Laborde
        eprint("ProjCoordTransGeoKey: CT_ObliqueMercator_Laborde not implemented\n");
        break;
      case 5: // CT_ObliqueMercator_Rosenmund
        eprint("ProjCoordTransGeoKey: CT_ObliqueMercator_Rosenmund not implemented\n");
        break;
      case 6: // CT_ObliqueMercator_Spherical
        eprint("ProjCoordTransGeoKey: CT_ObliqueMercator_Spherical not implemented\n");
        break;
      case 7: // CT_Mercator
        eprint("ProjCoordTransGeoKey: CT_Mercator not implemented\n");
        break;
      case 9: // CT_LambertConfConic_Helmert
        eprint("ProjCoordTransGeoKey: CT_LambertConfConic_Helmert not implemented\n");
        break;
      case 10: // CT_LambertAzimEqualArea
        eprint("ProjCoordTransGeoKey: CT_LambertAzimEqualArea not implemented\n");
        break;
      case 12: // CT_AzimuthalEquidistant
        eprint("ProjCoordTransGeoKey: CT_AzimuthalEquidistant not implemented\n");
        break;
      case 13: // CT_EquidistantConic
        eprint("ProjCoordTransGeoKey: CT_EquidistantConic not implemented\n");
        break;
      case 14: // CT_Stereographic
        eprint("ProjCoordTransGeoKey: CT_Stereographic not implemented\n");
        break;
      case 15: // CT_PolarStereographic
        eprint("ProjCoordTransGeoKey: CT_PolarStereographic not implemented\n");
        break;
      case 17: // CT_Equirectangular
        eprint("ProjCoordTransGeoKey: CT_Equirectangular not implemented\n");
        break;
      case 18: // CT_CassiniSoldner
        eprint("ProjCoordTransGeoKey: CT_CassiniSoldner not implemented\n");
        break;
      case 19: // CT_Gnomonic
        eprint("ProjCoordTransGeoKey: CT_Gnomonic not implemented\n");
        break;
      case 20: // CT_MillerCylindrical
        eprint("ProjCoordTransGeoKey: CT_MillerCylindrical not implemented\n");
        break;
      case 21: // CT_Orthographic
        eprint("ProjCoordTransGeoKey: CT_Orthographic not implemented\n");
        break;
      case 22: // CT_Polyconic
        eprint("ProjCoordTransGeoKey: CT_Polyconic not implemented\n");
        break;
      case 23: // CT_Robinson
        eprint("ProjCoordTransGeoKey: CT_Robinson not implemented\n");
        break;
      case 24: // CT_Sinusoidal
        eprint("ProjCoordTransGeoKey: CT_Sinusoidal not implemented\n");
        break;
      case 25: // CT_VanDerGrinten
        eprint("ProjCoordTransGeoKey: CT_VanDerGrinten not implemented\n");
        break;
      case 26: // CT_NewZealandMapGrid
        eprint("ProjCoordTransGeoKey: CT_NewZealandMapGrid not implemented\n");
        break;
      case 27: // CT_TransvMercator_SouthOriented
        eprint("ProjCoordTransGeoKey: CT_TransvMercator_SouthOriented not implemented\n");
        break;
      default:
        eprint("ProjCoordTransGeoKey: look-up for %d not implemented\n", geo_keys[i].value_offset);
      }
      break;
  ...
  if (user_defined_projection)
  {
    if (user_defined_projection == 1)
    {
          ...
          (offsetProjScaleAtNatOriginGeoKey >= 0))
      {
        ...
        if (description)
        {
          snprintf(description, 256, "generic transverse mercator");
        }
        has_projection = true;
      }
    }
    else if (user_defined_projection == 8)
    {
          ...
          (offsetProjStdParallel2GeoKey >= 0))
      {
        ...
        if (description)
        {
          snprintf(description, 256, "generic lambert conformal conic");
        }
        has_projection = true;
      }
    }
    else if (user_defined_projection == 11)
    {
          ...
          (offsetProjStdParallel2GeoKey >= 0))
      {
        ...
        if (description)
        {
          snprintf(description, 256, "generic albers equal area");
        }
        has_projection = true;
      }
    }
    else if (user_defined_projection == 16)
    {
          ...
          (offsetProjScaleAtNatOriginGeoKey >= 0))
      {
        ...
        if (description)
        {
          snprintf(description, 256, "generic oblique stereographic");
        }
        has_projection = true;
      }
    }
    else if (user_defined_projection == 3)
    {
          ...
          (offsetProjScaleAtCenterGeoKey >= 0))
      {
        ...
        if (description)
        {
          snprintf(description, 256, "generic hotine oblique mercator");
        }
        has_projection = true;
      }
    }
...
bool GeoProjectionConverter::get_geo_keys_from_projection(int& num_geo_keys, GeoProjectionGeoKeys** geo_keys, int& num_geo_double_params, double** geo_double_params, bool source)
{
  ...
  if (projection)
  {
    ...
    if (projection->type == GEO_PROJECTION_UTM || projection->type == GEO_PROJECTION_LCC || projection->type == GEO_PROJECTION_TM || projection->type == GEO_PROJECTION_AEAC || projection->type == GEO_PROJECTION_HOM || projection->type == GEO_PROJECTION_OS)
    {
      ...
      {
        eprint("get_geo_keys_from_projection for generic projection not implemented\n");
      }
    }
...
static int print_ogc_wkt_spheroid(char* string, short spheroid_code)
{
  ...
  {
    n = snprintf(string, 4096, "SPHEROID[\"WGS 84\",6378137,298.257223563,AUTHORITY[\"EPSG\",\"7030\"]],");
  }
  else if (spheroid_code == GEO_SPHEROID_GRS80)
  {
    n = snprintf(string, 4096, "SPHEROID[\"GRS 1980\",6378137,298.257222101,AUTHORITY[\"EPSG\",\"7019\"]],");
  }
  else if (spheroid_code == GEO_SPHEROID_WGS72)
  {
    n = snprintf(string, 4096, "SPHEROID[\"WGS 72\",6378135,298.26,AUTHORITY[\"EPSG\",\"7043\"]],");
  }
  else if (spheroid_code == GEO_SPHEROID_GRS67)
  {
    n = snprintf(string, 4096, "SPHEROID[\"GRS 1967\",6378160,298.247167427,AUTHORITY[\"EPSG\",\"7036\"]],");
  }
  else if (spheroid_code == GEO_SPHEROID_CLARKE1866)
  {
    n = snprintf(string, 4096, "SPHEROID[\"Clarke 1866\",6378206.4,294.9786982139006,AUTHORITY[\"EPSG\",\"7008\"]],");
  }
  else if (spheroid_code == GEO_SPHEROID_INTERNATIONAL)
  {
    n = snprintf(string, 4096, "SPHEROID[\"International 1924\",6378388,297,AUTHORITY[\"EPSG\",\"7022\"]],");
  }
  else if (spheroid_code == GEO_SPHEROID_BESSEL1841)
  {
    n = snprintf(string, 4096, "SPHEROID[\"Bessel 1841\",6377397.155,299.1528128,AUTHORITY[\"EPSG\",\"7004\"]],");
  }
  else if (spheroid_code == GEO_SPHEROID_AIRY)
  {
    n = snprintf(string,4096, "SPHEROID[\"Airy 1830\",6377563.396,299.3249646,AUTHORITY[\"EPSG\",\"7001\"]],");
  }
  return n;
}
...
static int print_ogc_wkt_datum(char* string, const char* datum_name, short datum_code, short spheroid_code)
{
  ...
  n += snprintf(&string[n], 4096, "DATUM[\"%s\",", datum_name);
  n += print_ogc_wkt_spheroid(&string[n], spheroid_code);
  n += snprintf(&string[n], 4096, "AUTHORITY[\"EPSG\",\"%d\"]],", datum_code);
...
static int print_ogc_wkt_geogcs(char* string, const char* gcs_name, short gcs_code, const char* datum_name, short datum_code, short spheroid_code)
{
  ...
  n += snprintf(&string[n], 4096, "GEOGCS[\"%s\",", gcs_name);
  n += print_ogc_wkt_datum(&string[n], datum_name, datum_code, spheroid_code);
  n += snprintf(&string[n], 4096, "PRIMEM[\"Greenwich\",0,AUTHORITY[\"EPSG\",\"8901\"]],UNIT[\"degree\",0.01745329251994328,AUTHORITY[\"EPSG\",\"9122\"]],AUTHORITY[\"EPSG\",\"%d\"]],", gcs_code);
...
bool GeoProjectionConverter::get_ogc_wkt_from_projection(int& len, char** ogc_wkt, bool source)
{
  ...
  if (projection)
  {
    ...
    {
      n += snprintf(&string[n], 4096, "GEOCCS[\"WGS 84\",DATUM[\"World Geodetic System 1984\",SPHEROID[\"WGS 84\",6378137.0,298.257223563,AUTHORITY[\"EPSG\",\"7030\"]],AUTHORITY[\"EPSG\",\"6326\"]],PRIMEM[\"Greenwich\",0.0,AUTHORITY[\"EPSG\",\"8901\"]],UNIT[\"m\",1.0],AXIS[\"Geocentric X\",OTHER],AXIS[\"Geocentric Y\",EAST],AXIS[\"Geocentric Z\",NORTH],AUTHORITY[\"EPSG\",\"4978\"]]");
    }
    else
    {
      ...
      if ((projection->type != GEO_PROJECTION_LAT_LONG) && (projection->type != GEO_PROJECTION_LONG_LAT))
      {
        ...
        if ((vertical_geokey == GEO_VERTICAL_NAVD88) || (vertical_geokey == GEO_VERTICAL_NGVD29) || (vertical_geokey == GEO_VERTICAL_CGVD2013) || (vertical_geokey == GEO_VERTICAL_EVRF2007) || (vertical_geokey == GEO_VERTICAL_CGVD28) || (vertical_geokey == GEO_VERTICAL_DVR90) || (vertical_geokey == GEO_VERTICAL_NN2000) || (vertical_geokey == GEO_VERTICAL_NN54) || (vertical_geokey == GEO_VERTICAL_DHHN92) || (vertical_geokey == GEO_VERTICAL_DHHN2016) || (vertical_geokey == GEO_VERTICAL_NZVD2016) )
        {
          ...
          if (source)
          {
            ...
            {
              n += snprintf(&string[n], 4096, "\",");
            }
            else if (elevation2meter == 0.3048)
            {
              n += snprintf(&string[n], 4096, " (ft)\",");
            }
            else
            {
              n += snprintf(&string[n], 4096, " (ftUS)\",");
            }
          }
          else
          {
        ...
        n += snprintf(&string[n], 4096, "PROJCS[\"%s\",", epsg_name);
        free(epsg_name);
      }
      // which datum
      if (gcs_code == GEO_GCS_NAD83_2011)
      {
        n += snprintf(&string[n], 4096, "GEOGCS[\"NAD83(2011)\",DATUM[\"NAD_1983_2011\",SPHEROID[\"GRS 1980\",6378137,298.257222101,AUTHORITY[\"EPSG\",\"7019\"]],AUTHORITY[\"EPSG\",\"1116\"]],PRIMEM[\"Greenwich\",0,AUTHORITY[\"EPSG\",\"8901\"]],UNIT[\"degree\",0.01745329251994328,AUTHORITY[\"EPSG\",\"9122\"]],AUTHORITY[\"EPSG\",\"6318\"]],");
      }
      else
      {
      ...
      if (projection->type == GEO_PROJECTION_LONG_LAT)
      {
        n--; // remove comma
        n--; // remove bracket
        n += snprintf(&string[n], 4096, ",AXIS[\"Longitude\",EAST],AXIS[\"Latitude\",NORTH]]");
      }
      else if (projection->type == GEO_PROJECTION_LAT_LONG) // or maybe geographic with reversed coordinates
      {
        n--; // remove comma
        n--; // remove bracket
        n += snprintf(&string[n], 4096, ",AXIS[\"Latitude\",NORTH],AXIS[\"Longitude\",EAST]]");
      }
      else // some real projection
      {
        if (projection->type == GEO_PROJECTION_UTM)
        {
          ...
          n += snprintf(&string[n], 4096, "PROJECTION[\"Transverse_Mercator\"],PARAMETER[\"latitude_of_origin\",0],PARAMETER[\"central_meridian\",%d],PARAMETER[\"scale_factor\",0.9996],PARAMETER[\"false_easting\",500000],PARAMETER[\"false_northing\",%d],", -183 + 6 * utm->utm_zone_number, (utm->utm_northern_hemisphere ? 0 : 10000000));
        }
        else if (projection->type == GEO_PROJECTION_LCC)
        {
          GeoProjectionParametersLCC* lcc = (GeoProjectionParametersLCC*)projection;
          n += snprintf(&string[n], 4096, "PROJECTION[\"Lambert_Conformal_Conic_2SP\"],PARAMETER[\"standard_parallel_1\",%.15g],PARAMETER[\"standard_parallel_2\",%.15g],PARAMETER[\"latitude_of_origin\",%.15g],PARAMETER[\"central_meridian\",%.15g],", lcc->lcc_first_std_parallel_degree, lcc->lcc_second_std_parallel_degree, lcc->lcc_lat_origin_degree, lcc->lcc_long_meridian_degree);
          if (source)
          {
            n += snprintf(&string[n], 4096, "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_northing\",%.15g],", lcc->lcc_false_easting_meter/coordinates2meter, lcc->lcc_false_northing_meter/coordinates2meter);
          }
          else
          {
            n += snprintf(&string[n], 4096, "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_northing\",%.15g],", lcc->lcc_false_easting_meter*meter2coordinates, lcc->lcc_false_northing_meter*meter2coordinates);
          }
        }
        else if (projection->type == GEO_PROJECTION_TM)
        {
          GeoProjectionParametersTM* tm = (GeoProjectionParametersTM*)projection;
          n += snprintf(&string[n], 4096, "PROJECTION[\"Transverse_Mercator\"],PARAMETER[\"latitude_of_origin\",%.15g],PARAMETER[\"central_meridian\",%.15g],PARAMETER[\"scale_factor\",%.15g],", tm->tm_lat_origin_degree, tm->tm_long_meridian_degree, tm->tm_scale_factor);
          if (source)
          {
            n += snprintf(&string[n], 4096, "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_northing\",%.15g],", tm->tm_false_easting_meter/coordinates2meter, tm->tm_false_northing_meter/coordinates2meter);
          }
          else
          {
            n += snprintf(&string[n], 4096, "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_northing\",%.15g],", tm->tm_false_easting_meter*meter2coordinates, tm->tm_false_northing_meter*meter2coordinates);
          }
        }
        else if (projection->type == GEO_PROJECTION_AEAC)
        {
          GeoProjectionParametersAEAC* aeac = (GeoProjectionParametersAEAC*)projection;
          n += snprintf(&string[n], 4096, "PROJECTION[\"Albers_Conic_Equal_Area\"],PARAMETER[\"standard_parallel_1\",%.15g],PARAMETER[\"standard_parallel_2\",%.15g],PARAMETER[\"latitude_of_center\",%.15g],PARAMETER[\"longitude_of_center\",%.15g],", aeac->aeac_first_std_parallel_degree, aeac->aeac_second_std_parallel_degree, aeac->aeac_latitude_of_center_degree, aeac->aeac_longitude_of_center_degree);
          if (source)
          {
            n += snprintf(&string[n], 4096, "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_northing\",%.15g],", aeac->aeac_false_easting_meter/coordinates2meter, aeac->aeac_false_northing_meter/coordinates2meter);
          }
          else
          {
            n += snprintf(&string[n], 4096, "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_northing\",%.15g],", aeac->aeac_false_easting_meter*meter2coordinates, aeac->aeac_false_northing_meter*meter2coordinates);
          }
        }
        else if (projection->type == GEO_PROJECTION_HOM)
        {
          GeoProjectionParametersHOM* hom = (GeoProjectionParametersHOM*)projection;
          n += snprintf(&string[n], 4096, "PROJECTION[\"Hotine_Oblique_Mercator\"],PARAMETER[\"latitude_of_center\",%.15g],PARAMETER[\"longitude_of_center\",%.15g],PARAMETER[\"azimuth\",%.15g],PARAMETER[\"rectified_grid_angle\",%.15g],PARAMETER[\"scale_factor\",%.15g],", hom->hom_latitude_of_center_degree, hom->hom_longitude_of_center_degree, hom->hom_azimuth_degree, hom->hom_rectified_grid_angle_degree , hom->hom_scale_factor);
          if (source)
          {
            n += snprintf(&string[n], 4096, "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_northing\",%.15g],", hom->hom_false_easting_meter/coordinates2meter, hom->hom_false_northing_meter/coordinates2meter);
          }
          else
          {
            n += snprintf(&string[n], 4096, "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_northing\",%.15g],", hom->hom_false_easting_meter*meter2coordinates, hom->hom_false_northing_meter*meter2coordinates);
          }
        }
        else if (projection->type == GEO_PROJECTION_OS)
        {
          GeoProjectionParametersOS* os = (GeoProjectionParametersOS*)projection;
          n += snprintf(&string[n], 4096, "PROJECTION[\"Oblique_Stereographic\"],PARAMETER[\"latitude_of_origin\",%.15g],PARAMETER[\"central_meridian\",%.15g],PARAMETER[\"scale_factor\",%.15g],", os->os_lat_origin_degree, os->os_long_meridian_degree, os->os_scale_factor);
          if (source)
          {
            n += snprintf(&string[n], 4096, "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_northing\",%.15g],", os->os_false_easting_meter/coordinates2meter, os->os_false_northing_meter/coordinates2meter);
          }
          else
          {
            n += snprintf(&string[n], 4096, "PARAMETER[\"false_easting\",%.15g],PARAMETER[\"false_northing\",%.15g],", os->os_false_easting_meter*meter2coordinates, os->os_false_northing_meter*meter2coordinates);
          }
        }
        else
        {
        ...
        if (source)
        {
          ...
          {
            n += snprintf(&string[n], 4096, "UNIT[\"metre\",1,AUTHORITY[\"EPSG\",\"9001\"]],");
          }
          else if (coordinates2meter == 0.3048)
          {
            n += snprintf(&string[n], 4096, "UNIT[\"foot\",0.3048,AUTHORITY[\"EPSG\",\"9002\"]]");
          }
          else
          {
            n += snprintf(&string[n], 4096, "UNIT[\"US survey foot\",0.3048006096012192,AUTHORITY[\"EPSG\",\"9003\"]],");
          }
        }
        else
        {
        ...
        // axis
        n += snprintf(&string[n], 4096, "AXIS[\"Easting\",EAST],AXIS[\"Northing\",NORTH],");
        // authority
        ...
        {
          n += snprintf(&string[n], 4096, "AUTHORITY[\"EPSG\",\"%d\"]]", projection->geokey);
        }
        else
        {
          n += snprintf(&string[n], 4096, "]");
      ...
      if ((vertical_geokey == GEO_VERTICAL_NAVD88) || (vertical_geokey == GEO_VERTICAL_NGVD29) || (vertical_geokey == GEO_VERTICAL_CGVD2013) || (vertical_geokey == GEO_VERTICAL_EVRF2007) || (vertical_geokey == GEO_VERTICAL_CGVD28) || (vertical_geokey == GEO_VERTICAL_DVR90) || (vertical_geokey == GEO_VERTICAL_NN2000) || (vertical_geokey == GEO_VERTICAL_NN54) || (vertical_geokey == GEO_VERTICAL_DHHN92) || (vertical_geokey == GEO_VERTICAL_DHHN2016) || (vertical_geokey == GEO_VERTICAL_NZVD2016))
      {
        ...
        if (vertical_geokey == GEO_VERTICAL_NAVD88)
        {
          n += snprintf(&string[n], 4096,"VERT_CS[\"NAVD88");
          if (vertical_geoid)
          {
            if (vertical_geoid == GEO_VERTICAL_NAVD88_GEOID12B)
            {
          ...
          n += snprintf(&string[n], 4096, "\",VERT_DATUM[\"North American Vertical Datum 1988\",2005,AUTHORITY[\"EPSG\",\"5103\"]],");
        }
        else if (vertical_geokey == GEO_VERTICAL_NGVD29)
        {
          n += snprintf(&string[n], 4096, "VERT_CS[\"NGVD29\",VERT_DATUM[\"National Geodetic Vertical Datum 1929\",2005,AUTHORITY[\"EPSG\",\"5102\"]],");
        }
        else if (vertical_geokey == GEO_VERTICAL_CGVD2013)
        {
          n += snprintf(&string[n], 4096, "VERT_CS[\"CGVD2013\",VERT_DATUM[\"Canadian Geodetic Vertical Datum of 2013\",2005,AUTHORITY[\"EPSG\",\"1127\"]],");
        }
        else if (vertical_geokey == GEO_VERTICAL_EVRF2007)
        {
          n += snprintf(&string[n], 4096, "VERT_CS[\"EVRF2007\",VERT_DATUM[\"European Vertical Reference Frame 2007\",2005,AUTHORITY[\"EPSG\",\"5215\"]],");
        }
        else if (vertical_geokey == GEO_VERTICAL_CGVD28)
        {
          n += snprintf(&string[n], 4096, "VERT_CS[\"CGVD28\",VERT_DATUM[\"Canadian Geodetic Vertical Datum of 1928\",2005,AUTHORITY[\"EPSG\",\"5114\"]],");
        }
        else if (vertical_geokey == GEO_VERTICAL_DVR90)
        {
          n += snprintf(&string[n], 4096, "VERT_CS[\"DVR90\",VERT_DATUM[\"Dansk Vertikal Reference 1990\",2005,AUTHORITY[\"EPSG\",\"5206\"]],");
        }
        else if (vertical_geokey == GEO_VERTICAL_NN2000)
        {
          n += snprintf(&string[n], 4096, "VERT_CS[\"NN2000\",VERT_DATUM[\"Norway Normal Null 2000\",2005,AUTHORITY[\"EPSG\",\"1096\"]],");
        }
        else if (vertical_geokey == GEO_VERTICAL_NN54)
        {
          n += snprintf(&string[n], 4096, "VERT_CS[\"NN54\",VERT_DATUM[\"Norway Normal Null 1954\",2005,AUTHORITY[\"EPSG\",\"5174\"]],");
        }
        else if (vertical_geokey == GEO_VERTICAL_DHHN92)
        {
          n += snprintf(&string[n], 4096, "VERT_CS[\"DHHN92\",VERT_DATUM[\"Deutsches Haupthoehennetz 1992\",2005,AUTHORITY[\"EPSG\",\"5783\"]],");
        }
        else if (vertical_geokey == GEO_VERTICAL_DHHN2016)
        {
          n += snprintf(&string[n], 4096, "VERT_CS[\"DHHN2016\",VERT_DATUM[\"Deutsches Haupthoehennetz 2016\",2005,AUTHORITY[\"EPSG\",\"7837\"]],");
        }
        else if (vertical_geokey == GEO_VERTICAL_NZVD2016)
        {
          n += snprintf(&string[n], 4096, "VERT_CS[\"NZVD2016\",VERT_DATUM[\"New Zealand Vertical Datum 2016\",2005,AUTHORITY[\"EPSG\",\"7839\"]],");
        }
        if (source)
        {
          if (elevation2meter == 1.0)
          {
            n += snprintf(&string[n], 4096, "UNIT[\"metre\",1.0,AUTHORITY[\"EPSG\",\"9001\"]],");
          }
          else if (elevation2meter == 0.3048)
          {
            n += snprintf(&string[n], 4096, "UNIT[\"foot\",0.3048,AUTHORITY[\"EPSG\",\"9002\"]],");
        ...
        if (vertical_geokey == GEO_VERTICAL_NAVD88)
        {
          n += snprintf(&string[n], 4096, "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"%d\"]]", ((source && (elevation2meter == 1.0)) || (!source && (meter2elevation == 1.0)) ? 5703 : 6360));
        }
        else if (vertical_geokey == GEO_VERTICAL_NGVD29)
        {
          n += snprintf(&string[n], 4096, "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5702\"]]");
        }
        else if (vertical_geokey == GEO_VERTICAL_CGVD2013)
        {
          n += snprintf(&string[n], 4096, "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"6647\"]]");
        }
        else if (vertical_geokey == GEO_VERTICAL_EVRF2007)
        {
          n += snprintf(&string[n], 4096, "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5621\"]]");
        }
        else if (vertical_geokey == GEO_VERTICAL_CGVD28)
        {
          n += snprintf(&string[n], 4096, "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5713\"]]");
        }
        else if (vertical_geokey == GEO_VERTICAL_DVR90)
        {
          n += snprintf(&string[n], 4096, "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5799\"]]");
        }
        else if (vertical_geokey == GEO_VERTICAL_NN2000)
        {
          n += snprintf(&string[n], 4096, "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5941\"]]");
        }
        else if (vertical_geokey == GEO_VERTICAL_NN54)
        {
          n += snprintf(&string[n], 4096, "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5776\"]]");
        }
        else if (vertical_geokey == GEO_VERTICAL_DHHN92)
        {
          n += snprintf(&string[n], 4096, "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"5783\"]]");
        }
        else if (vertical_geokey == GEO_VERTICAL_DHHN2016)
        {
          n += snprintf(&string[n], 4096, "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"7837\"]]");
        }
        else if (vertical_geokey == GEO_VERTICAL_NZVD2016)
        {
          n += snprintf(&string[n], 4096, "AXIS[\"Gravity-related height\",UP],AUTHORITY[\"EPSG\",\"7839\"]]");
        }
...
static int print_prj_spheroid(char* string, short spheroid_code)
{
  ...
  if (spheroid_code == GEO_SPHEROID_WGS84)
  {
    n = snprintf(string, 4096, "SPHEROID[\"WGS 84\",6378137,298.257223563]");
  }
  else if (spheroid_code == GEO_SPHEROID_GRS80)
  {
    n = snprintf(string, 4096, "SPHEROID[\"GRS 1980\",6378137,298.257222101]");
  }
  else if (spheroid_code == GEO_SPHEROID_WGS72)
  {
    n = snprintf(string, 4096, "SPHEROID[\"WGS 72\",6378135,298.26]");
  }
  else if (spheroid_code == GEO_SPHEROID_GRS67)
  {
    n = snprintf(string, 4096, "SPHEROID[\"GRS 1967\",6378160,298.247167427]");
  }
  else if (spheroid_code == GEO_SPHEROID_CLARKE1866)
  {
    n = snprintf(string, 4096, "SPHEROID[\"Clarke 1866\",6378206.4,294.9786982139006]");
  }
  else if (spheroid_code == GEO_SPHEROID_INTERNATIONAL)
  {
    n = snprintf(string, 4096, "SPHEROID[\"International 1924\",6378388,297]");
  }
  else if (spheroid_code == GEO_SPHEROID_BESSEL1841)
  {
    n = snprintf(string, 4096, "SPHEROID[\"Bessel 1841\",6377397.155,299.1528128]");
  }
  else if (spheroid_code == GEO_SPHEROID_AIRY)
  {
    n = snprintf(string, 4096, "SPHEROID[\"Airy 1830\",6377563.396,299.3249646]");
  }
  return n;
}
...
static int print_prj_datum(char* string, const char* datum_name, short datum_code, short spheroid_code)
{
  ...
  {
    n += snprintf(&string[n], 4096, "DATUM[\"D_WGS_1984\",");
  }
  else
  {
    n += snprintf(&string[n], 4096, "DATUM[\"D_%s\",", datum_name);
  }
...
static int print_prj_geogcs(char* string, const char* gcs_name, short gcs_code, const char* datum_name, short datum_code, short spheroid_code)
{
  ...
  n += snprintf(&string[n], 4096, "PRIMEM[\"Greenwich\",0],UNIT[\"Degree\",0.017453292519943295]],");
  ...
  if (projection)
  {
    ...
    else
    {
      ...
      if ((projection->type != GEO_PROJECTION_LAT_LONG) && (projection->type != GEO_PROJECTION_LONG_LAT))
      {
        ...
        {
          n += snprintf(&string[n], 4096, "PROJCS[\"%s\",", projection->name);
        }
      }
      // which datum
      if (gcs_code == GEO_GCS_WGS84)
      {
        n += snprintf(&string[n], 4096, "GEOGCS[\"GCS_WGS_1984\",DATUM[\"D_WGS_1984\",SPHEROID[\"WGS 84\",6378137,298.257223563]],PRIMEM[\"Greenwich\",0],UNIT[\"Degree\",0.017453292519943295]],");
      }
      else if ((gcs_code == GEO_GCS_NAD83) || (gcs_code == GEO_GCS_NAD83_HARN) || (gcs_code == GEO_GCS_NAD83_CSRS) || (gcs_code == GEO_GCS_NAD83_PA11) || (gcs_code == GEO_GCS_NAD83_2011))
      {
        ...
        {
          n += snprintf(&string[n], 4096, "GEOGCS[\"GCS_North_American_1983\",DATUM[\"D_North_American_1983\",");
        }
        else if (gcs_code == GEO_GCS_NAD83_HARN)
        {
          n += snprintf(&string[n], 4096, "GEOGCS[\"NAD83(HARN)\",DATUM[\"D_North_American_1983_HARN\",");
        }
        else if (gcs_code == GEO_GCS_NAD83_CSRS)
        {
          n += snprintf(&string[n], 4096, "GEOGCS[\"NAD83(CSRS)\",DATUM[\"D_NAD83_Canadian_Spatial_Reference_System\",");
        }
        else if (gcs_code == GEO_GCS_NAD83_PA11)
        {
          n += snprintf(&string[n], 4096, "GEOGCS[\"NAD83(PA11)\",DATUM[\"D_North_American_1983_PA11\",");
        }
        else
        {
          n += snprintf(&string[n], 4096, "GEOGCS[\"NAD83(2011)\",DATUM[\"D_North_American_1983_2011\",");
        }
        n += snprintf(&string[n], 4096, "SPHEROID[\"GRS 1980\",6378137,298.257222101]],PRIMEM[\"Greenwich\",0],UNIT[\"Degree\",0.017453292519943295]],");
      }
      else
      {
      ...
      else // some real projection
      {
        ...
        if (source)
        {
          if (coordinates2meter == 1.0)
          {
            n += snprintf(&string[n], 4096, "UNIT[\"Meter\",1]");
          }
          else if (coordinates2meter == 0.3048)
          {
            n += snprintf(&string[n], 4096, "UNIT[\"foot\",0.3048]");
          }
          else
          {
            n += snprintf(&string[n], 4096, "UNIT[\"US survey foot\",0.3048006096012192]");
          }
        }
        else
        {
    ...
    if ((vertical_geokey == GEO_VERTICAL_NAVD88) || (vertical_geokey == GEO_VERTICAL_NGVD29) || (vertical_geokey == GEO_VERTICAL_CGVD2013) || (vertical_geokey == GEO_VERTICAL_EVRF2007) || (vertical_geokey == GEO_VERTICAL_CGVD28) || (vertical_geokey == GEO_VERTICAL_DVR90) || (vertical_geokey == GEO_VERTICAL_NN2000) || (vertical_geokey == GEO_VERTICAL_NN54) || (vertical_geokey == GEO_VERTICAL_DHHN92) || (vertical_geokey == GEO_VERTICAL_DHHN2016) || (vertical_geokey == GEO_VERTICAL_NZVD2016))
    {
      if (vertical_geokey == GEO_VERTICAL_NAVD88)
      {
        n += snprintf(&string[n], 4096, "VERT_CS[\"NAVD88\",VERT_DATUM[\"North American Vertical Datum 1988\",2005,AUTHORITY[\"EPSG\",\"5103\"]],");
      }
      else if (vertical_geokey == GEO_VERTICAL_NGVD29)
      {
        n += snprintf(&string[n], 4096, "VERT_CS[\"NGVD29\",VERT_DATUM[\"National Geodetic Vertical Datum 1929\",2005,AUTHORITY[\"EPSG\",\"5102\"]],");
      ...
      if (source)
      {
        if (elevation2meter == 1.0)
        {
          n += snprintf(&string[n], 4096, "UNIT[\"metre\",1.0],");
        }
        else if (elevation2meter == 0.3048)
        {
          n += snprintf(&string[n], 4096, "UNIT[\"foot\",0.3048],");
...
bool GeoProjectionConverter::get_proj4_string_from_projection(int& len, char** proj4, bool source)
{
  ...
  if (projection)
  {
    ...
    {
      GeoProjectionParametersUTM* utm = (GeoProjectionParametersUTM*)projection;
      n += snprintf(&string[n], 1024, "+proj=utm +zone=%d%s ", utm->utm_zone_number, (utm->utm_northern_hemisphere ? "" : " +south"));
    }
    else if (projection->type == GEO_PROJECTION_LCC)
    {
      GeoProjectionParametersLCC* lcc = (GeoProjectionParametersLCC*)projection;
      n += snprintf(&string[n], 1024, "+proj=lcc +lat_1=%.15g +lat_2=%.15g +lat_0=%.15g +lon_0=%.15g +x_0=%.15g +y_0=%.15g ", lcc->lcc_first_std_parallel_degree, lcc->lcc_second_std_parallel_degree, lcc->lcc_lat_origin_degree, lcc->lcc_long_meridian_degree, lcc->lcc_false_easting_meter, lcc->lcc_false_northing_meter);
    }
    else if (projection->type == GEO_PROJECTION_TM)
    {
      GeoProjectionParametersTM* tm = (GeoProjectionParametersTM*)projection;
      n += snprintf(&string[n], 1024, "+proj=tmerc +lat_0=%.15g +lon_0=%.15g +k=%.15g +x_0=%.15g +y_0=%.15g ", tm->tm_lat_origin_degree, tm->tm_long_meridian_degree, tm->tm_scale_factor, tm->tm_false_easting_meter, tm->tm_false_northing_meter);
    }
    else if (projection->type == GEO_PROJECTION_AEAC)
    {
      GeoProjectionParametersAEAC* aeac = (GeoProjectionParametersAEAC*)projection;
      n += snprintf(&string[n], 1024, "+proj=albers +lat_1=%.15g +lat_2=%.15g +lat_0=%.15g +lon_0=%.15g +x_0=%.15g +y_0=%.15g ", aeac->aeac_first_std_parallel_degree, aeac->aeac_second_std_parallel_degree, aeac->aeac_latitude_of_center_degree, aeac->aeac_longitude_of_center_degree, aeac->aeac_false_easting_meter, aeac->aeac_false_northing_meter);
    }
    else if (projection->type == GEO_PROJECTION_HOM)
    {
      GeoProjectionParametersHOM* hom = (GeoProjectionParametersHOM*)projection;
      n += snprintf(&string[n], 1024, "+proj=omerc +lat_0=%.15g +lonc=%.15g +alpha=%.15g +gamma=%.15g +k=%.15g +x_0=%.15g +y_0=%.15g ", hom->hom_latitude_of_center_degree, hom->hom_longitude_of_center_degree, hom->hom_azimuth_degree, hom->hom_rectified_grid_angle_degree, hom->hom_scale_factor, hom->hom_false_easting_meter, hom->hom_false_northing_meter);
    }
    else if (projection->type == GEO_PROJECTION_OS)
    {
      GeoProjectionParametersOS* os = (GeoProjectionParametersOS*)projection;
      n += snprintf(&string[n], 1024, "+proj=sterea +lat_0=%.15g +lon_0=%.15g +k=%.15g +x_0=%.15g +y_0=%.15g ", os->os_lat_origin_degree, os->os_long_meridian_degree, os->os_scale_factor, os->os_false_easting_meter, os->os_false_northing_meter);
    }
    else if (projection->type == GEO_PROJECTION_LONG_LAT)
    {
      n += snprintf(&string[n], 1024, "+proj=longlat ");
    }
    else if (projection->type == GEO_PROJECTION_LAT_LONG)
    {
      n += snprintf(&string[n], 1024, "+proj=latlong ");
    }
    else if (projection->type == GEO_PROJECTION_ECEF)
    {
      n += snprintf(&string[n], 1024, "+proj=geocent ");
    }
    else
    {
      free(string);
    ...
    if (gcs_code == GEO_GCS_WGS84)
    {
      n += snprintf(&string[n], 1024, "+datum=WGS84 ");
    }
    ...
    {
      n += snprintf(&string[n], 1024, "+datum=NAD83 ");
    }
    else if (gcs_code == GEO_GCS_WGS72)
    {
      n += snprintf(&string[n], 1024, "+datum=WGS72 ");
    }
    else if (gcs_code == GEO_GCS_NAD27)
    {
      n += snprintf(&string[n], 1024, "+datum=NAD27 ");
    }
    else if (ellipsoid->id == GEO_ELLIPSOID_WGS84)
    {
      n += snprintf(&string[n], 1024, "+ellps=WGS84 ");
    }
    ...
    {
      n += snprintf(&string[n], 1024, "+ellps=WGS72 ");
    }
    ...
    {
      n += snprintf(&string[n], 1024, "+datum=bessel ");
    }
    else
    {
      free(string);
    ...
    if (has_coordinate_units(source))
    {
      if (source)
      {
        if (coordinates2meter == 1.0)
        {
          n += snprintf(&string[n], 1024, "+units=m ");
        }
        else
        {
          n += snprintf(&string[n], 1024, "+to_meter=%.15g ", coordinates2meter);
        }
      }
      else
      {
        ...
        {
          n += snprintf(&string[n], 1024, "+to_meter=%.15g ", meter2coordinates);
        }
      }
    }
    n += snprintf(&string[n], 1024, "+no_defs");
    len = n;
    *proj4 = string;
    return true;
  }
...
short GeoProjectionConverter::get_GeographicTypeGeoKey() const
{
  ...
  case GEO_ELLIPSOID_WGS84: // GCS_WGS_84
    return 4326;
  default:
    eprint("GeographicTypeGeoKey: look-up for ellipsoid with id %d not implemented\n", ellipsoid->id);
  }
  return 0;
}
...
bool GeoProjectionConverter::set_ProjectedCSTypeGeoKey(short value, char* description, bool source)
{
  if (value == 32767)
  {
    if (description)
    {
      snprintf(description, 256, "user-defined");
    }
    return true;
  }
  ...
  eprint("set_ProjectedCSTypeGeoKey: look-up for %d not implemented\n", value);
  return false;
}
      ...
      else
      {
        ...
        else if (ellipsoid->id == GEO_ELLIPSOID_GRS1980)
        {
          if (utm->utm_northern_hemisphere)
          {
            ...
            {
              eprint("get_ProjectedCSTypeGeoKey: northern UTM zone %d for NAD83 out-of-range\n", utm->utm_zone_number);
            }
          }
          else
          {
            if (gcs_code == GEO_GCS_GDA94)
            {
              ...
              {
                eprint("get_ProjectedCSTypeGeoKey: southern MGA zone %d for GDA94 does not exist\n", utm->utm_zone_number);
              }
            }
            else if (gcs_code == GEO_GCS_GDA2020)
            {
              ...
              {
                eprint("get_ProjectedCSTypeGeoKey: southern MGA zone %d for GDA2020 does not exist\n", utm->utm_zone_number);
              }
            }
            else
            {
              eprint("get_ProjectedCSTypeGeoKey: southern UTM zone %d for NAD83 does not exist\n", utm->utm_zone_number);
            }
          }
        }
        else if (ellipsoid->id == GEO_ELLIPSOID_CLARKE1866)
        {
          if (utm->utm_northern_hemisphere)
          {
            ...
            {
              eprint("get_ProjectedCSTypeGeoKey: northern UTM zone %d for NAD27 out-of-range\n", utm->utm_zone_number);
            }
          }
          else
          {
            eprint("get_ProjectedCSTypeGeoKey: southern UTM zone %d for NAD27 does not exist\n", utm->utm_zone_number);
          }
        }
        else if (ellipsoid->id == GEO_ELLIPSOID_GRS1967)
        {
          if (utm->utm_northern_hemisphere)
          {
            ...
            {
              eprint("get_ProjectedCSTypeGeoKey: northern UTM zone %d for SAD69 out-of-range\n", utm->utm_zone_number);
            }
          }
          else
          {
            ...
            {
              eprint("get_ProjectedCSTypeGeoKey: southern UTM zone %d for SAD69 out-of-range\n", utm->utm_zone_number);
            }
          }
        }
        else if (ellipsoid->id == GEO_ELLIPSOID_INTERNATIONAL)
        {
          if (utm->utm_northern_hemisphere)
          {
            ...
            {
              eprint("get_ProjectedCSTypeGeoKey: northern UTM zone %d for ED50 out-of-range\n", utm->utm_zone_number);
            }
          }
          else
          {
            eprint("get_ProjectedCSTypeGeoKey: southern UTM zone %d for ED50 does not exist\n", utm->utm_zone_number);
          }
        }
        else if (ellipsoid->id == GEO_ELLIPSOID_ID74)
        {
          if (utm->utm_northern_hemisphere)
          {
            ...
            {
              eprint("get_ProjectedCSTypeGeoKey: northern UTM zone %d for ID74 out-of-range\n", utm->utm_zone_number);
            }
          }
          else
          {
            ...
            {
              eprint("get_ProjectedCSTypeGeoKey: southern UTM zone %d for ID74 out-of-range\n", utm->utm_zone_number);
            }
          }
        }
        else
        {
          eprint("get_ProjectedCSTypeGeoKey: look-up for UTM zone %d and ellipsoid with id %d not implemented\n", utm->utm_zone_number, ellipsoid->id);
        }
      }
    }
    else if (projection->type == GEO_PROJECTION_LCC)
...
short GeoProjectionConverter::get_GeogEllipsoidGeoKey() const
{
  ...
  case 23: // Ellipse_WGS_84
    return 7030;
  default:
    eprint("GeogEllipsoidGeoKey: look-up for ellipsoid with id %d not implemented\n", ellipsoid->id);
  }
  return 0;
}
...
bool GeoProjectionConverter::set_ProjLinearUnitsGeoKey(short value, bool source)
{
  ...
  case 9003: // Linear_Foot_US_Survey
    ...
    break;
  default:
    eprint("set_ProjLinearUnitsGeoKey: look-up for %d not implemented\n", value);
    return false;
  }
  return true;
}
...
bool GeoProjectionConverter::set_VerticalUnitsGeoKey(short value)
{
  ...
  case 9003: // Linear_Foot_US_Survey
    ...
    break;
  default:
    eprint("set_VerticalUnitsGeoKey: look-up for %d not implemented\n", value);
    return false;
  }
  return true;
}
...
bool GeoProjectionConverter::set_VerticalCSTypeGeoKey(short value, char* description)
{
  if (value == GEO_VERTICAL_WGS84)
  {
    ...
    if (description) snprintf(description, 256, "WGS 84 Ellipsoid");
    return true;
  }
  else if (value == GEO_VERTICAL_NAVD88)
  {
    vertical_geokey = GEO_VERTICAL_NAVD88;
    if (description) snprintf(description, 256, "North American Vertical Datum 1988");
    return true;
  }
  else if (value == GEO_VERTICAL_DHHN2016)
  {
    vertical_geokey = GEO_VERTICAL_DHHN2016;
    if (description) snprintf(description, 256, "Deutsches Haupthoehennetz 2016");
    return true;
  }
  else if (value == GEO_VERTICAL_NZVD2016)
  {
    vertical_geokey = GEO_VERTICAL_NZVD2016;
    if (description) snprintf(description, 256, "New Zealand Vertical Datum 2016");
    return true;
  }
  else if (value == GEO_VERTICAL_DHHN92)
  {
    vertical_geokey = GEO_VERTICAL_DHHN92;
    if (description) snprintf(description, 256, "Deutsches Haupthoehennetz 1992");
    return true;
  }
  else if (value == GEO_VERTICAL_CGVD2013)
  {
    vertical_geokey = GEO_VERTICAL_CGVD2013;
    if (description) snprintf(description, 256, "Canadian Geodetic Vertical Datum of 2013");
    return true;
  }
  else if (value == GEO_VERTICAL_NN2000)
  {
    vertical_geokey = GEO_VERTICAL_NN2000;
    if (description) snprintf(description, 256, "Norway Normal Null 2000");
    return true;
  }
  else if (value == GEO_VERTICAL_NN54)
  {
    vertical_geokey = GEO_VERTICAL_NN54;
    if (description) snprintf(description, 256, "Norway Normal Null 1954");
    return true;
  }
  else if (value == GEO_VERTICAL_EVRF2007)
  {
    vertical_geokey = GEO_VERTICAL_EVRF2007;
    if (description) snprintf(description, 256, "European Vertical Reference Frame 2007");
    return true;
  }
  else if (value == GEO_VERTICAL_DVR90)
  {
    vertical_geokey = GEO_VERTICAL_DVR90;
    if (description) snprintf(description, 256, "Dansk Vertikal Reference 1990");
    return true;
  }
  else if (value == GEO_VERTICAL_NGVD29)
  {
    vertical_geokey = GEO_VERTICAL_NGVD29;
    if (description) snprintf(description, 256, "National Geodetic Vertical Datum 1929");
    return true;
  }
  else if (value == GEO_VERTICAL_CGVD28)
  {
    vertical_geokey = GEO_VERTICAL_CGVD28;
    if (description) snprintf(description, 256, "Canadian Geodetic Vertical Datum of 1928");
    return true;
  }
  else if ((5000 <= value) && (value <= 5099)) // [5000, 5099] = EPSG Ellipsoid Vertical CS Codes
  {
    vertical_geokey = value;
    if (description) snprintf(description, 256, "Some Ellipsoid Vertical Datum");
    return true;
  }
  else
  {
    ...
    if (file == 0)
    {
      eprint("ERROR: cannot open 'vertcs.csv' file. maybe your LAStools distribution\n");
      eprint("       has no .\\LAStools\\bin\\serf\\geo\\vertcs.csv file. download the\n");
      eprint("       latest version at http://lastools.org/download/LAStools.zip\n");
      return false;
    }
    int epsg_code = 0;
    char line[2048];
    while (fgets(line, 2048, file))
    {
      if (sscanf(line, "%d,", &epsg_code) == 1)
      {
        if (epsg_code == value)
        {
          ...
          if (description) snprintf(description, 256, "%s", name);
          run++;
          // skip two commas
          while (line[run] != ',') run++;
          run++;
          ...
          {
            eprint("failed to scan units from '%s'", line);
            return false;
          }
          if (!set_VerticalUnitsGeoKey(units))
          {
            eprint("units %d of EPSG code %d not implemented.\n", units, value);
            return false;
          }
          vertical_geokey = value;
          return true;
    ...
    eprint("EPSG code %d not found in 'vertcs.csv' file\n", value);
    fclose(file);
    file = 0;
  }
  eprint("set_VerticalCSTypeGeoKey: look-up for %d not implemented\012", value);
  return false;
}
...
bool GeoProjectionConverter::set_reference_ellipsoid(int id, char* description)
{
  ...
  if (description)
  {
    snprintf(description, 256, "%2d - %s (%g %g)", ellipsoid->id, ellipsoid->name, ellipsoid->equatorial_radius, ellipsoid->eccentricity_squared);
  }
...
bool GeoProjectionConverter::set_gcs(short code, char* description)
{
  ...
  if (code == GEO_GCS_WGS84)
  {
    ...
    snprintf(gcs_name, 28, "WGS 84");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "World_Geodetic_System_1984");
    spheroid_code = GEO_SPHEROID_WGS84;
  }
  else if (code == GEO_GCS_ETRS89)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1980);
    snprintf(gcs_name, 28, "ETRS89");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "European_Terrestrial_Reference_System_1989");
    spheroid_code = GEO_SPHEROID_GRS80;
  }
  else if (code == GEO_GCS_NAD83)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1980);
    snprintf(gcs_name, 28, "NAD83");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "North_American_Datum_1983");
    spheroid_code = GEO_SPHEROID_GRS80;
  }
  else if (code == GEO_GCS_GDA94)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1980);
    snprintf(gcs_name, 28, "GDA94");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "Geocentric_Datum_of_Australia_1994");
    spheroid_code = GEO_SPHEROID_GRS80;
  }
  else if (code == GEO_GCS_GDA2020)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1980);
    snprintf(gcs_name, 28, "GDA2020");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "Geocentric_Datum_of_Australia_2020");
    spheroid_code = GEO_SPHEROID_GRS80;
  }
  else if (code == GEO_GCS_WGS72)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_WGS72);
    snprintf(gcs_name, 28, "WGS 72");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "World_Geodetic_System_1972");
    spheroid_code = GEO_SPHEROID_WGS72;
  }
  else if (code == GEO_GCS_NAD83_HARN)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1980);
    snprintf(gcs_name, 28, "NAD83(HARN)");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "NAD83_High_Accuracy_Regional_Network");
    spheroid_code = GEO_SPHEROID_GRS80;
  }
  else if (code == GEO_GCS_NAD83_CSRS)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1980);
    snprintf(gcs_name, 28, "NAD83(CSRS)");
    datum_code = 6140;
    snprintf(datum_name, 60, "NAD83_Canadian_Spatial_Reference_System");
    spheroid_code = GEO_SPHEROID_GRS80;
  }
  else if (code == GEO_GCS_NAD83_PA11)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1980);
    snprintf(gcs_name, 28, "NAD83(PA11)");
  }
  else if (code == GEO_GCS_NAD83_2011)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1980);
    snprintf(gcs_name, 28, "NAD83(2011)");
  }
  else if (code == GEO_GCS_NZGD2000)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1980);
    snprintf(gcs_name, 28, "NZGD2000");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "New_Zealand_Geodetic_Datum_2000");
    spheroid_code = GEO_SPHEROID_GRS80;
  }
  else if (code == GEO_GCS_NAD27)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_CLARKE1866);
    snprintf(gcs_name, 28, "NAD27");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "North_American_Datum_1927");
    spheroid_code = GEO_ELLIPSOID_CLARKE1866;
  }
  else if (code == GEO_GCS_NAD83_NSRS2007)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1980);
    snprintf(gcs_name, 28, "NAD83(NSRS2007)");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "NAD83_National_Spatial_Reference_System_2007");
    spheroid_code = GEO_SPHEROID_GRS80;
  }
  else if (code == GEO_GCS_WGS72BE)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_WGS72);
    snprintf(gcs_name, 28, "WGS 72BE");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "WGS_1972_Transit_Broadcast_Ephemeris");
    spheroid_code = GEO_SPHEROID_WGS72;
  }
  else if (code == GEO_GCS_SAD69)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1967);
    snprintf(gcs_name, 28, "SAD69");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "South_American_Datum_1969");
    spheroid_code = GEO_ELLIPSOID_GRS1967;
  }
  else if (code == GEO_GCS_HD72)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_GRS1967);
    snprintf(gcs_name, 28, "HD72");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "Hungarian_Datum_1972");
    spheroid_code = GEO_ELLIPSOID_GRS1967;
  }
  else if (code == GEO_GCS_CH1903)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_BESSEL_1841);
    snprintf(gcs_name, 28, "CH1903");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "CH1903");
    spheroid_code = GEO_SPHEROID_BESSEL1841;
  }
  else if (code == GEO_GCS_OSGB1936)
  {
    set_reference_ellipsoid(GEO_ELLIPSOID_AIRY);
    snprintf(gcs_name, 28, "OSGB1936");
    datum_code = gcs_code + 2000;
    snprintf(datum_name, 60, "OSGB1936");
  ...
  else
  {
    ...
    if (file == 0)
    {
      eprint("ERROR: cannot open 'gcs.csv' file. maybe your LAStools distribution\n");
      eprint("       has no .\\LAStools\\bin\\serf\\geo\\gcs.csv file. download the\n");
      eprint("       latest version at http://lastools.org/download/LAStools.zip\n");
      return false;
    }
    int value = 0;
      ...
      if (sscanf(line, "%d,", &value) == 1)
      {
        if (code == value)
        {
          ...
          if (sscanf(&line[run], "%d,", &value) == 1)
          {
            ...
            if (ellipsoid_id != -1)
            {
//              eprint("set ellipsoid %d for EPSG code %d for '%s'\n", ellipsoid_id, value, gname);
              set_reference_ellipsoid(ellipsoid_id);
              snprintf(gcs_name, 28, "%s", gname);
              datum_code = dcode;
              snprintf(datum_name, 60, "%s", dname);
              spheroid_code = value;
              done = true;
              break;
            }
            ...
            {
              eprint("ERROR: ellipsoid with EPSG code %d for '%s' not supported\n", value, gname);
              break;
            }
          }
        }
    ...
    if (!done)
    {
      if (description) snprintf(description, 256, "unknown");
      return false;
    }
  }
  if (description) snprintf(description, 256, "%s", gcs_name);
  return true;
}
...
void GeoProjectionConverter::set_geokey(short geokey, bool source)
{
  if (source)
  {
    ...
    {
      eprint("WARNING: source_projection not set despite geokey %d\n", geokey);
    }
  }
  else
  {
    ...
    {
      eprint("WARNING: target_projection not set despite geokey %d\n", geokey);
    }
  }
}
...
void GeoProjectionConverter::check_geokey(short geokey, bool source)
{
  if (source)
  {
    if (source_projection)
    {
      ...
      {
        eprint("WARNING: source_projection->geokey %d != geokey %d\n", source_projection->geokey, geokey);
      }
    }
    else
    {
  ...
  else
  {
    if (target_projection)
    {
      ...
      {
        eprint("WARNING: target_projection->geokey %d != geokey %d\n", target_projection->geokey, geokey);
      }
    }
    else
    {
...
bool GeoProjectionConverter::set_latlong_projection(char* description, bool source)
{
  ...
  snprintf(latlong->name, 256, "latitude/longitude");
  set_projection(latlong, source);
  if (description)
  {
    snprintf(description, 256, "%s", latlong->name);
  }
  return true;
}
...
bool GeoProjectionConverter::set_no_projection(char* description, bool source)
{
  ...
  snprintf(no->name, 256, "intentionally no projection");
  set_projection(no, source);

  if (description)
  {
    snprintf(description, 256, "%s", no->name);
  }
  return true;
}
...
bool GeoProjectionConverter::set_longlat_projection(char* description, bool source)
{
  ...
  snprintf(longlat->name, 256, "longitude/latitude");
  set_projection(longlat, source);

  if (description)
  {
    snprintf(description, 256, "%s", longlat->name);
  }
  return true;
}
...
bool GeoProjectionConverter::set_ecef_projection(char* description, bool source, const char* name)
{
  ...
  if (name)
  {
    snprintf(ecef->name, 256, "%.255s", name);
  }
  else
  {
    snprintf(ecef->name, 256, "earth-centered earth-fixed");
  }
  set_projection(ecef, source);

  if (description)
  {
    snprintf(description, 256, "%s", ecef->name);
  }
  return true;
}
...
bool GeoProjectionConverter::set_utm_projection(char* zone, char* description, bool source, const char* name, bool is_mga)
{
  ...
  if (name)
  {
    snprintf(utm->name, 256, "%.255s", name);
  }
  else
  {
    snprintf(utm->name, 256, "%s zone %d%s", (is_mga ? "MGA" : "UTM"), zone_number, (utm->utm_northern_hemisphere ? "N" : "S"));
  }
  utm->utm_long_origin = (zone_number - 1) * 6 - 180 + 3; // + 3 puts origin in middle of zone
  set_projection(utm, source);
  if (description)
  {
    snprintf(description, 256, "%.255s", utm->name);
  }
  return true;
}
...
bool GeoProjectionConverter::set_utm_projection(int zone, bool northern, char* description, bool source, const char* name, bool is_mga)
{
  ...
  {
    snprintf(utm->name, 256, "%s / %s %d%s", gcs_name, (is_mga ? "MGA" : "UTM"), zone, (utm->utm_northern_hemisphere ? "N" : "S"));
  }
...
bool GeoProjectionConverter::set_target_utm_projection(char* description, const char* name)
{
  ...
  {
    snprintf(utm->name, 256, "auto select");
  }
  set_projection(utm, false);
  if (description)
  {
    snprintf(description, 256, "auto select");
  }
  return true;
}
...
void GeoProjectionConverter::set_lambert_conformal_conic_projection(double falseEastingMeter, double falseNorthingMeter, double latOriginDegree, double longMeridianDegree, double firstStdParallelDegree, double secondStdParallelDegree, char* description, bool source, const char* name)
{
  ...
  if (name)
  {
    snprintf(lcc->name, 256, "%.255s", name);
  }
  else
  {
    snprintf(lcc->name, 256, "Lambert Conformal Conic");
  }
  ...
  if (description)
  {
    snprintf(description, 256, "false east/north: %g/%g [m], origin lat/ meridian long: %g/%g, parallel 1st/2nd: %g/%g", lcc->lcc_false_easting_meter, lcc->lcc_false_northing_meter, lcc->lcc_lat_origin_degree, lcc->lcc_long_meridian_degree, lcc->lcc_first_std_parallel_degree, lcc->lcc_second_std_parallel_degree);
  }
}
...
void GeoProjectionConverter::set_transverse_mercator_projection(double falseEastingMeter, double falseNorthingMeter, double latOriginDegree, double longMeridianDegree, double scaleFactor, char* description, bool source, const char* name)
{
  ...
  if (name)
  {
    snprintf(tm->name, 256, "%.255s", name);
  }
  else
  {
    snprintf(tm->name, 256, "Transverse Mercator");
  }
  ...
  if (description)
  {
    snprintf(description, 256, "false east/north: %g/%g [m], origin lat/meridian long: %g/%g, scale: %g", tm->tm_false_easting_meter, tm->tm_false_northing_meter, tm->tm_lat_origin_degree, tm->tm_long_meridian_degree, tm->tm_scale_factor);
  }
}
...
void GeoProjectionConverter::set_albers_equal_area_conic_projection(double falseEastingMeter, double falseNorthingMeter, double latCenterDegree, double longCenterDegree, double firstStdParallelDegree, double secondStdParallelDegree, char* description, bool source, const char* name)
{
  ...
  if (name)
  {
    snprintf(aeac->name, 256, "%.255s", name);
  }
  else
  {
    snprintf(aeac->name, 256, "Albers Equal Area Conic");
  }
  ...
  if (description)
  {
    snprintf(description, 256, "false east/north: %g/%g [m], center lat/long: %g/%g, parallel 1st/2nd: %g/%g", aeac->aeac_false_easting_meter, aeac->aeac_false_northing_meter, aeac->aeac_latitude_of_center_degree, aeac->aeac_longitude_of_center_degree, aeac->aeac_first_std_parallel_degree, aeac->aeac_second_std_parallel_degree);
  }
}
...
void GeoProjectionConverter::set_hotine_oblique_mercator_projection(double falseEastingMeter, double falseNorthingMeter, double latCenterDegree, double longCenterDegree, double azimuthDegree, double rectifiedGridAngleDegree, double scaleFactor, char* description, bool source, const char* name)
{
  ...
  if (name)
  {
    snprintf(hom->name, 256, "%.255s", name);
  }
  else
  {
    snprintf(hom->name, 256, "Hotine Oblique Mercator");
  }
  ...
  if (description)
  {
    snprintf(description, 256, "false east/north: %g/%g [m], center lat/long: %g/%g, azimuth: %g angle: %g scale: %g", hom->hom_false_easting_meter, hom->hom_false_northing_meter, hom->hom_latitude_of_center_degree, hom->hom_longitude_of_center_degree, hom->hom_azimuth_degree, hom->hom_rectified_grid_angle_degree, hom->hom_scale_factor);
  }
}
...
void GeoProjectionConverter::set_oblique_stereographic_projection(double falseEastingMeter, double falseNorthingMeter, double latOriginDegree, double longMeridianDegree, double scaleFactor, char* description, bool source, const char* name)
{
  ...
  if (name)
  {
    snprintf(os->name, 256, "%.255s", name);
  }
  else
  {
    snprintf(os->name, 256, "Oblique Stereographic");
  }
  ...
  if (description)
  {
    snprintf(description, 256, "false east/north: %g/%g [m], origin lat/meridian long: %g/%g, scale: %g", os->os_false_easting_meter, os->os_false_northing_meter, os->os_lat_origin_degree, os->os_long_meridian_degree, os->os_scale_factor);
  }
}
...
//    eprint("length: %.15g fraction %.15g decimal: %.15g mins: %.15g secs: %.15g\n", length, fraction, decimal, mins, secs);
    return decimal;
  }
  else if (unit == 9105)
  {
...
bool GeoProjectionConverter::set_epsg_code(short value, char* description, bool source)
{
  ...
  default:
    ...
    if (file == 0)
    {
      eprint("ERROR: cannot open 'pcs.csv' file. maybe your LAStools distribution\n");
      eprint("       has no .\\LAStools\\bin\\serf\\geo\\pcs.csv file. download the\n");
      eprint("       latest version at http://lastools.org/download/LAStools.zip\n");
      return false;
    }
    int epsg_code = 0;
    ...
    while (fgets(line, 2048, file))
    {
      if (sscanf(line, "%d,", &epsg_code) == 1)
      {
        if (epsg_code == value)
        {
          ...
          {
            eprint("failed to scan units, gcs, and transform from '%s'", line);
            return false;
          }
          ...
          if (!set_gcs(gcs))
          {
            eprint("GCS %d of EPSG code %d not implemented.\n", gcs, value);
            return false;
          }
          // skip eight commas
          while (line[run] != ',') run++;
          ...
          if (transform == 9807) // CT_TransverseMercator
          {
            ...
            {
              eprint("failed to scan TM parameters from '%s'\n", line);
              return false;
            }
          ...
          else if (transform == 9802) // CT_LambertConfConic_2SP
          {
            ...
            {
              eprint("failed to scan LCC(2SP) parameters from '%s'\n", line);
              return false;
            }
            double latitude_of_origin_decdeg = unit2decdeg(latitude_of_origin, unit_latitude_of_origin);
            double central_meridian_decdeg = unit2decdeg(central_meridian, unit_central_meridian);
          ...
          else if (transform == 9801) // CT_LambertConfConic_1SP
          {
            ...
            {
              eprint("failed to scan LCC(1SP) parameters from '%s'\n", line);
              return false;
            }
            ...
            double false_northing_meter = unit2meter(false_northing, unit_false_northing);
/*
            eprint("Lambert Conic Conformal (1SP)\n");
            eprint("Latitude of natural origin:  %.10g\n", latitude_of_natural_origin_decdeg);
            eprint("Longitude of natural origin: %.10g\n", longitude_of_natural_origin_decdeg);
            eprint("Scale factor at natural origin: %.10g\n", scale_factor_at_natural_origin);
            eprint("False easting:  %.10g\n", false_easting_meter);
            eprint("False northing: %.10g\n", false_northing_meter);
*/
            if (scale_factor_at_natural_origin != 1.0) eprint("\nWARNING: current implementation for Lambert Conic Conformal (1SP) ignores scale factor %.10g and uses 1.0 instead\n", scale_factor_at_natural_origin);
          ...
          else if (transform == 9822) // CT_AlbersEqualArea
          {
            ...
            {
              eprint("failed to scan AEAC parameters from '%s'\n", line);
              return false;
            }
          ...
          else if (transform == 9812 || transform == 9815) // CT_HotineObliqueMercator (or CT_ObliqueMercator)
          {
            ...
            {
              eprint("failed to scan HOM parameters from '%s'\n", line);
              return false;
            }
            double false_easting_meter = unit2meter(false_easting, unit_false_easting);
            double false_northing_meter = unit2meter(false_northing, unit_false_northing);
          ...
          else if (transform == 9809) // CT_ObliqueStereographic
          {
            ...
            if (sscanf(&line[run], "%lf,%d,%d,%lf,%d,%d,%lf,%d,%d,%lf,%d,%d,%lf,%d", &latitude_of_origin, &unit_latitude_of_origin, &dummy, &central_meridian, &unit_central_meridian, &dummy, &scale_factor, &dummy, &dummy, &false_easting, &unit_false_easting, &dummy, &false_northing, &unit_false_northing) != 14)
            {
              eprint("failed to scan OS parameters from '%s'\n", line);
              return false;
            }
            double latitude_of_origin_decdeg = unit2decdeg(latitude_of_origin, unit_latitude_of_origin);
            double central_meridian_decdeg = unit2decdeg(central_meridian, unit_central_meridian);
          ...
          {
            eprint("transform %d of EPSG code %d not implemented.\n", transform, value);
            return false;
          }
        }
      }
    }
    eprint("EPSG code %d not found in 'pcs.csv' file\n", value);
    fclose(file);
    file = 0;
    return false;
  }
...
bool GeoProjectionConverter::compute_utm_zone(const double LatDegree, const double LongDegree, GeoProjectionParametersUTM* utm) const
{
  ...
  snprintf(utm->name, 256, "UTM %d%s", utm->utm_zone_number, (utm->utm_northern_hemisphere ? "N" : "S"));
...
bool GeoProjectionConverter::parse(int argc, char* argv[])
{
  ...
  for (i = 1; i < argc; i++)
  {
    ...
    else if (strcmp(argv[i],"-ellipsoid") == 0)
    {
      if ((i+1) >= argc)
      {
        eprint("ERROR: '%s' needs 1 argument: ellipsoid_id\n", argv[i]);
        return false;
      }
      int ellipsoid_id = atoi(argv[i+1]);
      if (set_reference_ellipsoid(ellipsoid_id, tmp))
      {
        if (verbose) eprint("using ellipsoid '%s'\n", tmp);
      }
      else
      {
        eprint("ERROR: ellipsoid with id %d is unknown. use one of those: \n", ellipsoid_id);
        ellipsoid_id = 1;
    ...
    else if (strcmp(argv[i],"-wgs84") == 0)
    {
      ...
      if (verbose) eprint("using datum '%s' with ellipsoid '%s'\n", tmp, get_ellipsoid_name());
      *argv[i]='\0';
    }
    ...
    else if (strncmp(argv[i],"-vertical_", 10) == 0)
    {
      if (strncmp(argv[i],"-vertical_navd88", 16) == 0)
      {
        ...
        {
          eprint("WARNING: unknown specialization of NAVD88 '%s'\n", argv[i] + 16);
        }
        *argv[i]='\0';
      }
      ...
      else if (strcmp(argv[i],"-vertical_epsg") == 0)
      {
        if ((i+1) >= argc)
        {
          eprint("ERROR: '%s' needs 1 argument: EPSG code\n", argv[i]);
          return false;
        }
        unsigned int code = 0;
        if (sscanf(argv[i+1], "%u", &code) != 1)
        {
          eprint("ERROR: '%s' needs 1 argument: EPSG code but '%s' is not a valid code\n", argv[i], argv[i+1]);
          return false;
        }
        if (code > 32767)
        {
          eprint("ERROR: '%s' needs 1 argument: EPSG code but %u is not a valid code\n", argv[i], code);
          return false;
        }
        if (!set_VerticalCSTypeGeoKey(code))
        {
          eprint("ERROR: unknown vertical EPSG code in '%s %s'.\n", argv[i], argv[i+1]);
          return false;
        }
        else
        {
          if (verbose) eprint("using vertical EPSG code %d\n", code);
        }
        *argv[i]='\0'; *argv[i+1]='\0'; i+=1;
      }
    }
    ...
    else if (strcmp(argv[i],"-utm") == 0 || strcmp(argv[i],"-target_utm") == 0)
    {
      ...
      if (!source && (strcmp(argv[i+1],"auto") == 0))
      {
        ...
        if (verbose) eprint("using target projection UTM '%s'\n", tmp);
      }
      else
      {
        if (argv[i+1][1] == 'n')
        ...
        {
          if (verbose) eprint("using %s UTM '%s'\n", (source ? "projection" : "target projection"), tmp);
        }
        else
        {
          eprint("ERROR: utm zone '%s' is unknown. use '32north', '55south', '10n', '56s', '17U', or '49L'\n", argv[i+1]);
          return false;
        }
      }
      *argv[i]='\0'; *argv[i+1]='\0'; i+=1;
    ...
    else if (strcmp(argv[i],"-epsg") == 0 || strcmp(argv[i],"-target_epsg") == 0)
    {
      ...
      {
        eprint("ERROR: unknown EPSG code in '%s %s'.\n", argv[i], argv[i+1]);
        return false;
      }
      else
      {
        if (verbose) eprint("using %s EPSG code %d\n", (source ? "projection" : "target projection"), code);
      }
      *argv[i]='\0'; *argv[i+1]='\0'; i+=1;
    }
    else if (strcmp(argv[i],"-lcc") == 0 || strcmp(argv[i],"-target_lcc") == 0)
    {
      ...
      {
        eprint("ERROR: wrong options for '-lcc'. use like shown in these examples:\n");
        eprint("  %s 609601.22 0 meter 33.75 -79 34.33333 36.16666\n", argv[i]);
        eprint("  %s 1640416.666667 0 survey_feet 47.000000 -120.833333 47.5 48.733333\n", argv[i]);
        eprint("  %s 1500000 0 feet 47.000000 -120.833333 47.5 48.733333\n", argv[i]);
        return false;
      }
      ...
      if (verbose) eprint("using LCC %s '%s'\n", (source ? "projection" : "target projection"), tmp);
    ...
    else if (strcmp(argv[i],"-sp83") == 0 || strcmp(argv[i],"-target_sp83") == 0)
    {
      ...
      {
        if (verbose) eprint("using %s '%s' (NAD83 LCC) '%s'\n", (source ? "state plane" : "target state plane"), argv[i+1], tmp);
      }
      else if (set_state_plane_nad83_tm(argv[i+1], tmp, source))
      {
        if (verbose) eprint("using %s '%s' (NAD83 TM) '%s'\n", (source ? "state plane" : "target state plane"), argv[i+1], tmp);
      }
      else
      {
        eprint("ERROR: bad state code in '%s %s'.\n", argv[i], argv[i+1]);
    ...
    else if (strcmp(argv[i],"-sp27") == 0 || strcmp(argv[i],"-target_sp27") == 0)
    {
      ...
      {
        if (verbose) eprint("using %s '%s' (NAD27 LCC) '%s'\n", (source ? "state plane" : "target state plane"), argv[i+1], tmp);
      }
      else if (set_state_plane_nad27_tm(argv[i+1], tmp, source))
      {
        if (verbose) eprint("using %s '%s' (NAD27 TM) '%s'\n", (source ? "state plane" : "target state plane"), argv[i+1], tmp);
      }
      else
      {
        eprint("ERROR: bad state code in '%s %s'.\n", argv[i], argv[i+1]);
    ...
    else if (strcmp(argv[i],"-tm") == 0 || strcmp(argv[i],"-transverse_mercator") == 0 || strcmp(argv[i],"-target_tm") == 0)
    {
      ...
      {
        eprint("ERROR: wrong options for '%s'. use like shown in these examples:\n",argv[i]);
        eprint("  %s 500000 0 meter 0 -93 0.99996\n",argv[i]);
        eprint("  %s 1500000 0 feet 47 -120.833333 0.99996\n",argv[i]);
        eprint("  %s 1640416.666667 0 survey_feet 47 -120.833333 0.99996\n",argv[i]);
        return false;
      }
      ...
      if (verbose) eprint("using TM %s '%s'\n", (source ? "projection" : "target projection"), tmp);
    ...
    else if (strcmp(argv[i],"-aeac") == 0 || strcmp(argv[i],"-target_aeac") == 0)
    {
      ...
      {
        eprint("ERROR: wrong options for '-aeac'. use like shown in these examples:\n");
        eprint("  %s 609601.22 0 meter 33.75 -79 34.33333 36.16666\n", argv[i]);
        eprint("  %s 1640416.666667 0 survey_feet 47.000000 -120.833333 47.5 48.733333\n", argv[i]);
        eprint("  %s 1500000 0 feet 47.000000 -120.833333 47.5 48.733333\n", argv[i]);
        return false;
      ...
      if (verbose) eprint("using AEAC %s '%s'\n", (source ? "projection" : "target projection"), tmp);
      *argv[i]='\0'; *argv[i+1]='\0';  *argv[i+2]='\0';  *argv[i+3]='\0';  *argv[i+4]='\0';  *argv[i+5]='\0';  *argv[i+6]='\0';  *argv[i+7]='\0'; i+=7;
    }
...
bool GeoProjectionConverter::check_horizontal_datum_before_reprojection()
{
  if (source_projection && target_projection)
  {
    ...
    {
      eprint("WARNING: horizontal datum of source unspecified. assuming same as target.\n");
      source_projection->datum = target_projection->datum;
      return true;
    }
    else if (target_projection->datum == 0)
    {
//      eprint("WARNING: horizontal datum of target unspecified. assuming same as source.\n");
      target_projection->datum = source_projection->datum;
      return true;
    }
    else
    {
      eprint("SERIOUS WARNING: horizontal datum of source and target incompatible.\n");
      return false;
    }
  }
  return false;
  ...
  if (projection)
  {
    ...
    else if ((projection->type == GEO_PROJECTION_LCC) || (projection->type == GEO_PROJECTION_TM))
    {
      ...
      if ((geokey != 0) && (geokey != 32767))
      {
        ...
        default:
          *coordinate_zone = 0;
          eprint("state plane with geotiff tag %d not implemented\n", (int)geokey);
        }
        if (*coordinate_zone)
        {
          *horizontal_datum = 2;
